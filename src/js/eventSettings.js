export const eventSettings = event => ({
  ...
  latitude: () => event._embedded.venues[0].location.latitude ? event._embedded.venues[0].location.latitude : 0,
  longitude: () => event._embedded.venues[0].location.longitude ? event._embedded.venues[0].location.longitude : 0,
